    ...
    <div class="card-body">
        <div class="card-tabs">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a href="/profile/{{ $sharedData['user']->username }}/followers"
                        class="nav-link">Followers({{$sharedData['followersCount']}})</a></li>
                <li class="nav-item"><a href="/profile/{{ $sharedData['user']->username }}/following"
                        class="nav-link active">Following({{$sharedData['followingCount']}})</a></li>
            ...
            <div class="tab-content">
                ...
                <div id="tab-top-1" class="card tab-pane active show" role="tabpanel">
                    <div class="card-body">
                        <div class="card-title">Following List</div>
                        <div class="list-group list-group-flush list-group-hoverable overflow-auto "
                            ...
                            <div class="list-group-item">
                                ...
                                @foreach ($following as $follow)
                                    {{-- user --}}
                                    <a href="/profile/{{$follow->userBeingFollowed->username}}" class="row mb-3 ">
                                        <div class="col-auto">
                                            <div>
                                                <span class="avatar"
                                        ...
                                        <div class="col text-truncate">
                                            <div class="text-body d-block">{{ $follow->userBeingFollowed->username }}
                                            </div>
